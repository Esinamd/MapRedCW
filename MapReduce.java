...
public class MapReduce {
    private static String bNumber;
      ...
      public static void main(String[] args) throws Exception{
        ...
        if (args[2].equals("")){ // setting default value to
            bNumber = "927160";
        } else {
            bNumber = args[2];
        }
    ...
    public static class MRMapper extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            words = words.replaceAll("\\p{P}", "").toLowerCase(); //remove all punctuation and make lowercase
        ...
        public void tokenise (Context context, StringTokenizer itr, int n) throws IOException, InterruptedException {
            while (itr.hasMoreTokens()) {
                ...
                ngram.set(String.valueOf(l));
                context.write(ngram, occ); // initial ngram
